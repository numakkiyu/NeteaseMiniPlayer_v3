...
- 可用的 NMPv3 构建产物：
  ...
  - CDN：`https://cdn.jsdelivr.net/npm/@netease-mini-player/v3@latest/dist/nmpv3.min.js`
...
```html
<p>{nmpv3:song=1901371647, api-base-url=/api/netease, embed=article, lyric=false}</p>
```
